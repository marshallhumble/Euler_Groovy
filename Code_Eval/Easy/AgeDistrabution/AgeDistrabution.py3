...
You're responsible for providing a demographic report for your local school district based on age. To do this,
...
Your program should accept as its first argument a path to a filename. Each line of input contains one integer -
age of the person:
...
categories = {
    tuple(range(0, 3)): "Still in Mama's arms",
    tuple(range(3, 5)): "Preschool Maniac",
    tuple(range(5, 12)): "Elementary school",
    tuple(range(12, 15)): "Middle school",
    tuple(range(15, 19)): "High school",
    tuple(range(19, 23)): "College",
    tuple(range(23, 66)): "Working for the man",
    tuple(range(66, 100)): "The Golden Years"
}

for line in test_cases:
    age, human = int(line), False
