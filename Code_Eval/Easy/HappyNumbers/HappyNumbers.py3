...
number by the sum of the squares of its digits, and repeat the process until
...
1
0
For the curious, here's why 7 is a happy number: 7->49->97->130->10->1. Here's why 22 is NOT a happy
number: 22->8->64->52->29->85->89->145->42->20->4->16->37->58->89 ...
"""
...
with open(argv[1], 'r') as f:
    ...
    for test in test_cases:
        all_nums, happy_num, num, count = [], 1, test, 0
        while not num == 1:
            num = sum(int(i) ** 2 for i in str(num))
            count += 1
            if num in all_nums or count == 200:
                happy_num = 0
                break
            else:
                all_nums.append(num)
